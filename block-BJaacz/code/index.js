...
function addTwoToArray(num){
  ...
  for (let i=0;i<num.length;i++){
      newArr.push(addTwo(num[i]));
    }
    return newArr;
  }
  console.log(addTwoToArray[2,4,6]);
/*
...
*/
function addThreeToArray(num){
  let newArr=[];
  for (let i=0;i<num.length;i++){
    newArr.push(addThree(num[i]))
  }
  return newArr;
}
/*
...
*/
function isGradeA(detail){
  return detail.grade>12;
}
/*
...
*/
function isGradeB(detail){
  return detail.grade>8 && detail.grade<=12; 
}
/*
...
*/
function isGradeC(detail){
  return detail.grade<=8;
}
/*
